...
@HandlerType(type = HandlerIds.LEGION_JOINOUT)
public class LegionJoinOutHandler extends BaseHandler {
	...
	public void execute(IOMessage ioMessage) {
		...
		legionModule.JoinOutLegion(playerID, legionID, legionType,protocol);
