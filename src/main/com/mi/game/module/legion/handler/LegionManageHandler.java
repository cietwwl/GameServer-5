...
@HandlerType(type = HandlerIds.LEGION_MANAGE)
public class LegionManageHandler extends BaseHandler {
	...
	public void execute(IOMessage ioMessage) {
		...
		// 玩家ID
		String legionPlayerID = (String) ioMessage.getInputParse("legionPlayerID");
		// 军团密码
		...
		legionModule.manageLegion(playerID, legionID, legionType, legionPlayerID, password, protocol);
