...
@HandlerType(type = HandlerIds.WELFARE_LOGIN)
public class WelfareLoginHandler extends BaseHandler {
	...
	public void execute(IOMessage ioMessage) {
		...
		WelfareLoginProtocol protocol = new WelfareLoginProtocol();
		welfareModule.eventLogin(playerID,rewardID, protocol);
