...
@HandlerType(type = HandlerIds.WELFARE_LEVEL)
public class WelfareLevelHandler extends BaseHandler {
	...
	public void execute(IOMessage ioMessage) {
		...
		WelfareLevelProtocol protocol = new WelfareLevelProtocol();
		welfareModule.eventLevel(playerID, rewardID, protocol);
