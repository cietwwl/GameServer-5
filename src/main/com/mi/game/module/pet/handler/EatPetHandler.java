...
@HandlerType(type = HandlerIds.EatPet)
public class EatPetHandler extends BaseHandler{
	@Override
	public void execute(IOMessage ioMessage){
		...
		if(ioMessage.getInputParse("eatID") != null){
			eatID = Long.parseLong(ioMessage.getInputParse("eatID").toString());
		}
		...
		petModule.eatPet(playerID, petID, eatID, protocol);
