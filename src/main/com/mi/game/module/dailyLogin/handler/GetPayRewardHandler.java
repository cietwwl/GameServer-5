 ...
 */
@HandlerType(type = HandlerIds.EVENT_DAILY_LOGIN_GET_PAYREWARD)
public class GetPayRewardHandler extends BaseHandler {
	...
	public void execute(IOMessage ioMessage) {
		...
		loginModule.getDailyPayReward(playerID, pid, protocol, ioMessage);
