...
@HandlerType(type = HandlerIds.FESTIVAL_EXCHANGEDIAMOND)
public class FestivalValentineHandler extends BaseHandler{
	@Override
	public void execute(IOMessage ioMessage){
		String playerID = ioMessage.getPlayerId();
		FestivalValentineProtocol protocol  = new FestivalValentineProtocol();
		FestivalModule festivalModule = ModuleManager.getModule(ModuleNames.FestivalModule,FestivalModule.class);
		try{
			festivalModule.exchangeDiamond(playerID, protocol, ioMessage);
