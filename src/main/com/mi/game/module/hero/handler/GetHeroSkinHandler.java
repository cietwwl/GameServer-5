...
@HandlerType(type = HandlerIds.getHeroSkin)
public class GetHeroSkinHandler extends BaseHandler{
	@Override
	public void execute(IOMessage ioMessage){
		...
		HeroSkinEntity heroSkinEntity = heroModule.getHerosSkinEntity(playerID, ioMessage);
