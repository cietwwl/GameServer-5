...
@HandlerType(type = HandlerIds.PlunderTalismanList)
public class GetPlunderListHandler extends BaseHandler{
	@Override
	public void execute(IOMessage ioMessage){
		...
		try{
			talismanModule.getPlunderInfo(playerID, shardID, ioMessage, protocol);
